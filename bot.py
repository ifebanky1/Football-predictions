...
async def start(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text("Welcome! I will send you daily football betting tips.")
...
# Function to send daily tips to all subscribed users at 8 AM
...
# Set up the scheduler for daily tips at 8 AM
scheduler = BackgroundScheduler()
scheduler.add_job(lambda: asyncio.run(send_daily_tips()), 'cron', hour=8, minute=0)
scheduler.start()
