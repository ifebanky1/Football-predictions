...
async def start(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text("Welcome! You will receive daily football betting tips at 3:36 AM.")
...
# Function to send daily tips to all subscribed users at 3:36 AM
...
# Set up the scheduler for daily tips at 3:36 AM
scheduler = BackgroundScheduler()
scheduler.add_job(lambda: asyncio.run(send_daily_tips()), 'cron', hour=3, minute=36)
scheduler.start()
